#Clock
create_clock -period 16.000 -name clk_50M -waveform {0.000 8.000} [get_ports clk_50M]
...
set_input_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 17.000 [get_ports {base_ram_data[*]}]
set_input_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 17.000 [get_ports {ext_ram_data[*]}]

set_input_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports reset_btn]

set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports {base_ram_addr[*]}]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports {base_ram_be_n[*]}]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports {base_ram_data[*]}]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports base_ram_oe_n]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports base_ram_we_n]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports {ext_ram_addr[*]}]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports {ext_ram_be_n[*]}]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports {ext_ram_data[*]}]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports ext_ram_oe_n]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports ext_ram_we_n]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports ext_ram_ce_n]
#set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 12.000 [get_ports {leds[*]}]

set_input_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 10.000 [get_ports rxd]
set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 10.000 [get_ports txd]
