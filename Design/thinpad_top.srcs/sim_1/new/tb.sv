...
parameter BASE_RAM_INIT_FILE = "C:\\Users\\XM-LEE\\Desktop\\MIPS\\thinpad_top.srcs\\sim_1\\test3.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�??????
parameter EXT_RAM_INIT_FILE = "C:\\Users\\XM-LEE\\Desktop\\MIPS\\thinpad_top.srcs\\sim_1\\lab1.bin";    //ExtRAM初始化文件，请修改为实际的绝对路�??????
parameter FLASH_INIT_FILE = "/tmp/kernel.elf";    //Flash初始化文件，请修改为实际的绝对路�??????
